<div id="left-sidebar" class="sidebar">
        <div class="sidebar-scroll">
            <div class="user-account">
                <img src="{{asset('assets/images/favicon/android-chrome-512x512.png')}}" class="rounded-circle user-photo" alt="User Profile Picture">
                <div class="dropdown">
                    <span><b>Welcome To <br>Parallax Technologies</b></span>
                </div>
            </div>
                ...
                <div class="tab-pane active" id="admin">
                    <nav class="sidebar-nav">
                        <ul class="main-menu metismenu">
                            <li class="active"><a href="{{route('unit.index')}}"><i class="icon-grid"></i><span>Dashboard</span></a></li>
                        </ul>
                    </nav>
                </div>
